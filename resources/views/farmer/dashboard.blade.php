...
<div class="container py-4">
    ...
    <div class="row g-4 mb-4">
        ...
        {{-- Feature 5: Rating stat --}}
        <div class="col-sm-6 col-lg-3">
            <a href="{{ route('farmer.reviews.index') }}" class="text-decoration-none">
                <div class="stat-card" style="background: linear-gradient(135deg, #7c5c00, #f5a623);">
                    <div class="stat-icon"><i class="bi bi-star-fill"></i></div>
                    <div class="stat-value">
                        {{ $stats['avg_rating'] ? number_format($stats['avg_rating'], 1) : '—' }}
                    </div>
                    <div class="stat-label">
                        Avg Rating ({{ $stats['total_reviews'] }} {{ Str::plural('review', $stats['total_reviews']) }})
                    </div>
                </div>
            </a>
        </div>
