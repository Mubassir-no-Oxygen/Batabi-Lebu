...
<div class="container mt-4">
    ...
    <div class="card mb-3">
        <div class="card-header d-flex justify-content-between">
            ...
            <span class="badge bg-{{ $report->status === 'pending' ? 'warning text-dark' : ($report->status === 'resolved' ? 'success' : 'secondary') }}">
        ...
        <div class="card-body">
            ...
            @if($report->evidence_path)
                <p><strong>Evidence:</strong>
                    <a href="{{ asset('storage/' . $report->evidence_path) }}" target="_blank">View File</a>
                </p>
            @endif
            <hr>
